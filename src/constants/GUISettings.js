...
// export const N_CELLS = 16; //1024
// export const N_CELLS = 21; //1396
// export const N_CELLS = 5; //375
...
export const head_move_interval = (w=window.innerWidth) => 49;
export const head_right_boundary = (w=window.innerWidth) => HEAD_LEFT_BOUNDARY + (N_CELLS - 1) * HEAD_MOVE_INTERVAL;
export const head_x = (w=window.innerWidth) => HEAD_LEFT_BOUNDARY + Math.floor(N_CELLS/2) * HEAD_MOVE_INTERVAL;
